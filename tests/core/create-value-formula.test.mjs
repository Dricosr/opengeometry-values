...
import { DOMAIN_STRINGS } from "../../src/constants/domain-string-catalog.mjs";
...
describe("createValue - unit-embedded numeric input", () => {
  ...
  it("parses 2m and stores correctly", () => {
    const v = make("2m", MATHJS_STRINGS.METER);
  ...
  it("parses 1h for time quantity", () => {
    const v = createValue({ value: "1h", unit: MATHJS_STRINGS.HOUR, quantity: QUANTITY_TYPES.TIME, valueType: VALUE_TYPES.FLOAT });
...
describe("createValue - formula with plain number result", () => {
  ...
  it("evaluates formula with pi for angle", () => {
    const v = createValue({ value: "=pi", unit: MATHJS_STRINGS.RADIAN, quantity: QUANTITY_TYPES.ANGLE, valueType: VALUE_TYPES.FLOAT });
  ...
  it("edit in same unit returns bare formula", () => {
    const v = createValue({
      ...
      quantity: QUANTITY_TYPES.LENGTH,
      valueType: VALUE_TYPES.FLOAT,
      output: new Output({ unit: MATHJS_STRINGS.METER, showUnit: false })
    });
  ...
  it("edit in different unit appends original unit to formula", () => {
    const v = createValue({
      ...
      quantity: QUANTITY_TYPES.LENGTH,
      valueType: VALUE_TYPES.FLOAT,
      output: new Output({ unit: MATHJS_STRINGS.MILLIMETER, showUnit: false })
    });
...
describe("createValue - formula with embedded units - area", () => {
  ...
  it("resolves 1 m^2 + 5000 cm^2", () => {
    const v = createValue({ value: "=1 m^2 + 5000 cm^2", unit: MATHJS_STRINGS.SQUARE_METER, quantity: QUANTITY_TYPES.AREA, valueType: VALUE_TYPES.FLOAT });
  ...
  it("edit returns formula as-is", () => {
    const v = createValue({
      ...
      valueType: VALUE_TYPES.FLOAT,
      output: new Output({ unit: MATHJS_STRINGS.SQUARE_CENTIMETER, showUnit: false })
    });
...
describe("createValue - formula with embedded units - volume", () => {
  ...
  it("resolves 1000 L to 1 m^3", () => {
    const v = createValue({ value: "=1000 L", unit: MATHJS_STRINGS.CUBIC_METER, quantity: QUANTITY_TYPES.VOLUME, valueType: VALUE_TYPES.FLOAT });
    expect(v.internal.value).toBeCloseTo(1, 10);
  });

  it("resolves 1 m^3 + 500 L", () => {
    const v = createValue({ value: "=1 m^3 + 500 L", unit: MATHJS_STRINGS.CUBIC_METER, quantity: QUANTITY_TYPES.VOLUME, valueType: VALUE_TYPES.FLOAT });
    expect(v.internal.value).toBeCloseTo(1.5, 10);
  });
});
...
describe("createValue - formula with embedded units - angle", () => {
  ...
  it("resolves 45 deg + 30 deg", () => {
    const v = createValue({ value: "=45 deg + 30 deg", unit: MATHJS_STRINGS.RADIAN, quantity: QUANTITY_TYPES.ANGLE, valueType: VALUE_TYPES.FLOAT });
    expect(v.internal.value).toBeCloseTo(75 * Math.PI / 180, 8);
  });

  it("resolves 2 deg * 2", () => {
    const v = createValue({ value: "=2 deg * 2", unit: MATHJS_STRINGS.RADIAN, quantity: QUANTITY_TYPES.ANGLE, valueType: VALUE_TYPES.FLOAT });
    expect(v.internal.value).toBeCloseTo(4 * Math.PI / 180, 8);
  });

  it("resolves pi rad", () => {
    const v = createValue({ value: "=pi rad", unit: MATHJS_STRINGS.RADIAN, quantity: QUANTITY_TYPES.ANGLE, valueType: VALUE_TYPES.FLOAT });
    expect(v.internal.value).toBeCloseTo(Math.PI, 8);
  });
  ...
  it("edit in deg returns formula as-is (embedded units)", () => {
    const v = createValue({
      ...
      valueType: VALUE_TYPES.FLOAT,
      output: new Output({ unit: MATHJS_STRINGS.DEGREE, showUnit: false })
    });
...
describe("createValue - formula with embedded units - temperature", () => {
  ...
  it("resolves 273.15 K to degC", () => {
    const v = createValue({ value: "=273.15 K", unit: MATHJS_STRINGS.DEGREE_CELSIUS, quantity: QUANTITY_TYPES.TEMPERATURE, valueType: VALUE_TYPES.FLOAT });
    expect(v.internal.value).toBeCloseTo(0, 3);
  });

  it("resolves 20 degC", () => {
    const v = createValue({ value: "=20 degC", unit: MATHJS_STRINGS.DEGREE_CELSIUS, quantity: QUANTITY_TYPES.TEMPERATURE, valueType: VALUE_TYPES.FLOAT });
  ...
  it("edit in degF returns formula as-is", () => {
    const v = createValue({
      ...
      valueType: VALUE_TYPES.FLOAT,
      output: new Output({ unit: MATHJS_STRINGS.DEGREE_FAHRENHEIT, showUnit: false })
    });
...
describe("createValue - formula with embedded units - mass", () => {
  ...
  it("resolves 5 kg + 500 g", () => {
    const v = createValue({ value: "=5 kg + 500 g", unit: MATHJS_STRINGS.KILOGRAM, quantity: QUANTITY_TYPES.MASS, valueType: VALUE_TYPES.FLOAT });
...
describe("createValue - formula with embedded units - force", () => {
  ...
  it("resolves 1 kN + 500 N", () => {
    const v = createValue({ value: "=1 kN + 500 N", unit: MATHJS_STRINGS.NEWTON, quantity: QUANTITY_TYPES.FORCE, valueType: VALUE_TYPES.FLOAT });
    expect(v.internal.value).toBeCloseTo(1500, 10);
  });

  it("resolves 2.5 kN * 2", () => {
    const v = createValue({ value: "=2.5 kN * 2", unit: MATHJS_STRINGS.NEWTON, quantity: QUANTITY_TYPES.FORCE, valueType: VALUE_TYPES.FLOAT });
...
describe("createValue - formula with embedded units - pressure", () => {
  ...
  it("resolves 1 bar + 50 kPa", () => {
    const v = createValue({ value: "=1 bar + 50 kPa", unit: MATHJS_STRINGS.PASCAL, quantity: QUANTITY_TYPES.PRESSURE, valueType: VALUE_TYPES.FLOAT });
    expect(v.internal.value).toBeCloseTo(150000, 10);
  });

  it("resolves 250 MPa", () => {
    const v = createValue({ value: "=250 MPa", unit: MATHJS_STRINGS.PASCAL, quantity: QUANTITY_TYPES.PRESSURE, valueType: VALUE_TYPES.FLOAT });
...
describe("createValue - formula with embedded units - time", () => {
  ...
  it("resolves 1 h + 30 min", () => {
    const v = createValue({ value: "=1 h + 30 min", unit: MATHJS_STRINGS.SECOND, quantity: QUANTITY_TYPES.TIME, valueType: VALUE_TYPES.FLOAT });
    expect(v.internal.value).toBeCloseTo(5400, 5);
  });

  it("resolves 2 h - 15 min", () => {
    const v = createValue({ value: "=2 h - 15 min", unit: MATHJS_STRINGS.SECOND, quantity: QUANTITY_TYPES.TIME, valueType: VALUE_TYPES.FLOAT });
    expect(v.internal.value).toBeCloseTo(6300, 5);
  });

  it("resolves 90 min", () => {
    const v = createValue({ value: "=90 min", unit: MATHJS_STRINGS.SECOND, quantity: QUANTITY_TYPES.TIME, valueType: VALUE_TYPES.FLOAT });
    expect(v.internal.value).toBeCloseTo(5400, 5);
  });
  ...
  it("edit returns formula as-is", () => {
    const v = createValue({
      ...
      valueType: VALUE_TYPES.FLOAT,
      output: new Output({ unit: MATHJS_STRINGS.MINUTE, showUnit: false })
    });
...
describe("createValue - formula error cases", () => {
  it("throws invalid_formula_expression for invalid expression", () => {
    ...
    expect(result.error.code).toBe(DOMAIN_STRINGS.ERROR_CODE_INVALID_FORMULA_EXPRESSION);
  });

  it("throws invalid_formula_expression for empty formula", () => {
    const result = tryCreateValue({ value: "=", unit: MATHJS_STRINGS.METER, quantity: QUANTITY_TYPES.LENGTH, valueType: VALUE_TYPES.FLOAT });
    expect(result.ok).toBe(false);
    expect(result.error.code).toBe(DOMAIN_STRINGS.ERROR_CODE_INVALID_FORMULA_EXPRESSION);
  });
  ...
  it("throws invalid_formula_expression when embedded unit is incompatible with quantity", () => {
    const result = tryCreateValue({ value: "=4m + 2cm", unit: MATHJS_STRINGS.SQUARE_METER, quantity: QUANTITY_TYPES.AREA, valueType: VALUE_TYPES.FLOAT });
    expect(result.ok).toBe(false);
    expect(result.error.code).toBe(DOMAIN_STRINGS.ERROR_CODE_INVALID_FORMULA_EXPRESSION);
  });

  it("throws invalid_formula_expression for mixed incompatible units", () => {
    const result = tryCreateValue({ value: "=4m + 2 kg", unit: MATHJS_STRINGS.METER, quantity: QUANTITY_TYPES.LENGTH, valueType: VALUE_TYPES.FLOAT });
    expect(result.ok).toBe(false);
    expect(result.error.code).toBe(DOMAIN_STRINGS.ERROR_CODE_INVALID_FORMULA_EXPRESSION);
  });
  ...
  it("throws invalid_integer_value when formula result is fractional for INTEGER type", () => {
    ...
    expect(result.ok).toBe(false);
    expect(result.error.code).toBe(DOMAIN_STRINGS.ERROR_CODE_INVALID_INTEGER_VALUE);
  });
});
