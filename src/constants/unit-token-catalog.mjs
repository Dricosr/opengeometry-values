...
const UNIT_TOKEN_ENTRIES = Object.freeze({
  METER: "m",
  CENTIMETER: "cm",
  MILLIMETER: "mm",
  INCH: "in",
...
export class UnitTokenCatalog extends ReadOnlyCatalog {
  constructor() {
    super(UNIT_TOKEN_ENTRIES);
  }
}

export const unitTokenCatalog = new UnitTokenCatalog();
export const UNIT_TOKENS = unitTokenCatalog.all();
