...
export const ANGLE_SAMPLES = Object.freeze({
  ...
  "angle:truss-pitch-4-12": createSample({
    ...
    description: "Roof truss slope 4 in 12 = 18.43deg -- common residential slope.",
  ...
  "angle:truss-pitch-6-12": createSample({
    ...
    description: "Roof truss slope 6 in 12 = 26.57deg -- steep slope for snow shedding.",
  ...
  "angle:truss-pitch-12-12": createSample({
    ...
    description: "Roof truss slope 12 in 12 = 45deg -- steep pitch for cathedral ceilings.",
    input: { value: 45, unit: UNIT_TOKENS.DEGREE },
  ...
  "angle:stair-stringer": createSample({
    ...
    description: "Typical stair stringer rise/run for 7in rise x 11in run = ~32.5deg per IBC.",
  ...
  "angle:conical-tank-bottom": createSample({
    ...
    description: "ASME conical bottom slope -- 60deg included angle for hopper bottoms.",
  ...
  "angle:structural-brace": createSample({
    ...
    description: "Diagonal brace angle for X-bracing in steel frames -- typically 45deg or 30-60deg.",
    input: { value: 45, unit: UNIT_TOKENS.DEGREE },
    recommendedOutputPresetIds: ["angle:annotation-symbol", "angle:slope-symbol"]
  }),
  "angle:auger-flight": createSample({
    ...
    description: "Screw conveyor/auger flight pitch angle -- typically ~25deg for granular materials.",
  ...
  "angle:pipe-elbow-radian": createSample({
    ...
    quantity: QUANTITY_TYPES.ANGLE,
    valueType: VALUE_TYPES.NUMBER,
    name: "90deg Elbow in Radians",
    description: "Standard long-radius 90deg pipe elbow -- π/2 rad (1.5708 rad) per ASME B16.9.",
  ...
  "angle:right-angle-integer": createSample({
    ...
    description: "Orthogonal framing angle -- 90deg stored as an integer for grid-locked geometry.",
