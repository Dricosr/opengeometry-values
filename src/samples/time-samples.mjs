...
export const TIME_SAMPLES = Object.freeze({
  ...
  "time:weld-arc-time": createSample({
    ...
    valueType: VALUE_TYPES.NUMBER,
    name: "Weld Arc Time",
    description: "Arc-on time per weld pass -- 3.5 minutes for a 1/4in fillet 6in long.",
  ...
  "time:asphalt-cooldown": createSample({
    ...
    description: "HMA cooldown to rolling temp (175 degF) -- 20 minutes per AASHTO.",
  ...
  "time:paint-dry-time": createSample({
    ...
    description: "Alkyd enamel dry-to-touch time at 77 degF -- 6 hours per manufacturer.",
  ...
  "time:epoxy-cure": createSample({
    ...
    description: "Two-part structural epoxy full cure at 75 degF -- 24 h per manufacturer data sheet.",
