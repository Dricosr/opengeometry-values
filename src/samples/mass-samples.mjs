...
export const MASS_SAMPLES = Object.freeze({
  ...
  "mass:rebar-weight-4": createSample({
    ...
    description: "US #4 rebar (1/2in) -- 0.668 lb/ft = 0.994 kg/m per ASTM A615.",
  ...
  "mass:rebar-weight-8": createSample({
    ...
    description: "US #8 rebar (1in) -- 2.670 lb/ft = 3.973 kg/m.",
  ...
  "mass:pipe-weight-2inch-sch40": createSample({
    ...
    quantity: QUANTITY_TYPES.MASS,
    valueType: VALUE_TYPES.NUMBER,
    name: "2in Sch 40 Pipe Weight per ft",
    description: "NPS 2in Schedule 40 -- 3.653 lb/ft (5.44 kg/m) per ASME B36.10.",
  ...
  "mass:wire-rope-3-4": createSample({
    ...
    quantity: QUANTITY_TYPES.MASS,
    valueType: VALUE_TYPES.NUMBER,
    name: "3/4in Wire Rope Weight per ft",
    description: "6x19 IWRC wire rope -- 3/4in dia = 1.53 lb/ft (2.28 kg/m) per API 9A.",
