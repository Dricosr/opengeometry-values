...
export const VOLUME_SAMPLES = Object.freeze({
  ...
  "volume:swimming-pool": createSample({
    ...
    description: "Residential in-ground pool -- 20,000 US gallons (~75.7 m3).",
  ...
  "volume:truck-load": createSample({
    ...
    description: "Standard dump truck heaped capacity -- ~12 m3 aggregates.",
  ...
  "volume:hydraulic-accumulator": createSample({
    ...
    quantity: QUANTITY_TYPES.VOLUME,
    valueType: VALUE_TYPES.NUMBER,
    name: "Hydraulic Accumulator (cm3)",
    description: "Small bladder accumulator pre-charge volume -- 500 cm3 for low-pressure circuits.",
  ...
  "volume:instrument-cavity": createSample({
    ...
    quantity: QUANTITY_TYPES.VOLUME,
    valueType: VALUE_TYPES.NUMBER,
    name: "Instrument Cavity (in3)",
    description: "Conduit body LB cavity -- 3.8 in3 minimum per NEC 314.16 for wire fill.",
  ...
  "volume:hydraulic-piston-displacement": createSample({
    ...
    quantity: QUANTITY_TYPES.VOLUME,
    valueType: VALUE_TYPES.NUMBER,
    name: "Hydraulic Piston Displacement (in3)",
    description: "2-in bore x 6-in stroke cylinder displacement -- 18.85 in3 per actuator data sheet.",
  ...
  "volume:concrete-pour-integer": createSample({
    ...
    quantity: QUANTITY_TYPES.VOLUME,
    valueType: VALUE_TYPES.NUMBER,
    name: "Concrete Pour (Integer m3)",
    description: "Whole-number concrete volume for a mat slab pour -- 50 m3.",
