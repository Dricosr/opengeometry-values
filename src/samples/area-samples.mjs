...
export const AREA_SAMPLES = Object.freeze({
  ...
  "area:nozzle-bore-cm2": createSample({
    ...
    quantity: QUANTITY_TYPES.AREA,
    valueType: VALUE_TYPES.FLOAT,
    name: "Nozzle Bore Area (cm²)",
    description: "Flow area of a 4-in NPS nozzle bore — approximately 81 cm² per ASME B16.5.",
  ...
  "area:bay-grid-integer": createSample({
    ...
    name: "Structural Bay Area (Integer m²)",
    description: "6 m × 8 m structural bay — 48 m² stored as integer for grid-aligned BIM.",
