...
- Every rename must improve clarity over the original.
- Avoid: `data`, `info`, `handler`, `util`, `temp`, `new`, `old`, unnecessary abbreviations.
- Prefer: names that reflect the actual domain operation, consistent with sibling files.
